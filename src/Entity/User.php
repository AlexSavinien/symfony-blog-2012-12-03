...
class User implements UserInterface, \Serializable
{
    ...
    /**
     * Mot de passe en clair pour intéragir avec le formulaire
     *
     * @var string
    ...
    /**
     * Returns l'attribut qui va servir d'identifiant pour se connecter (il vaut mieux qu'il soit unique).
     *
